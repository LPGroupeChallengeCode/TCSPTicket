...
module.exports = function(app) {
	...
	//incription
	app.get('/inscription/app/:nom/:prenom/:email/:password', function(req, res, next){
		...
		user.password = md5(req.params.password);
	...
	//login
	app.get('/login/app/:email/:password', function(req, res, next){
