...
module.exports = function(app) {
		...
		commande.save(function(err, commande){
			...
			User.findById(req.body.userId, function(err, user){
				...
				user.save(function(err, user){
					...
					createqrcode(commande.tickets.toString(), commande._id);
					...
					transporter.sendMail(mailOptions, function(error, info){
						...
						else
						{
							...
							res.redirect('http://localhost:8888/BilletterieTCSP/index.php?payment=true');                    
							res.end();				
						}
					});
				});
	...
	function createqrcode(qrticket, commandeId){
		//creation qrcode avec nom idcommande.png
		var qr_png = qr.image(qrticket, {type : 'png'})
		qr_png.pipe(fs.createWriteStream('images/qrcode/'+commandeId+'.png'));
		qrcode_file = commandeId+'.png';
